...
CREATE TABLE IF NOT EXISTS "estudiante" (
  ...
  "condicion" BOOLEAN DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS "discapacidad" (
  ...
  "porcentaje" INTEGER(11) DEFAULT NULL,
  "carnet" varchar(50) NOT NULL,
  "id_estudiante" INTEGER(11) DEFAULT NULL,
  PRIMARY KEY ("Id"),
...
CREATE TABLE IF NOT EXISTS "matricula" (
  "Id" INTEGER(11) NOT NULL AUTO_INCREMENT,
  "id_grado" INTEGER(11) DEFAULT NULL,
  "id_periodo" INTEGER(11) DEFAULT NULL,
  "id_estudiante" INTEGER(11) DEFAULT NULL,
  "id_paralelo" INTEGER(11) DEFAULT NULL,
  "numero" INTEGER(20) DEFAULT NULL,
  "created_at" timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY ("Id"),
...
CREATE TABLE IF NOT EXISTS "responsables" (
  ...
  "id_estudiante" INTEGER(11) NOT NULL,
  "foto" blob DEFAULT NULL,
  PRIMARY KEY ("Id"),
  KEY "ID_estudiante" ("id_estudiante"),
