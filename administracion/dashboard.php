...
// Obtener datos de estudiantes inactivos
...
<main>
    ...
    <style>
        ...
        select, p, label, input, li, ul, button, i, td, th, ul, nav, #example_previous,
            #example_paginate, #example_info, #example_next {
...
<script src="../src/datatables/jquery-3.5.1.js"></script>
<script src="../js/calendario.js"></script>
<script src="../js/eliminar_prematricula.js"></script>
<script src="../src/datatables/DataTables-1.13.4/js/jquery.dataTables.min.js"></script>
...
<script>
    $(document).ready(function() {
        $('#example').DataTable({
            ...
            autoWidth: true,
            language: {
                url: '../src/datatables/español.json',
            },
        });
    });
