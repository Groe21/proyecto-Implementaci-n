...
<div class="form-container" style="display: flex; flex-wrap: wrap;">
    <div class="form">
        ...
        <input type="text" class="input" id="cedula_papa" name="cedula_papa" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10)" required>
        <span class="input-border"></span>
    </div>
</div>
<div class="form-container" style="display: flex; flex-wrap: wrap;">
    <div class="form">
        ...
        <input type="text" class="input" id="apellidos_nombres_papa" name="apellidos_nombres_papa"  oninput="validarTexto(this)"  required>
        <span class=" input-border"></span>
    </div>
...
<div class="form-container" style="display: flex; flex-wrap: wrap;">
    <div class="form">
        ...
        <input type="text" class="input" id="telefono_papa" name="telefono_papa" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10)" required>
        <span class="input-border"></span>
    </div>
    <div class="form">
