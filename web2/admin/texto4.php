...
.formulario-destacado input[type="submit"] {
    ...
    width: auto; /* Ajusta el tamaño del botón según su contenido */
    padding: 1em 2em; /* Aumenta el tamaño del botón, asegurando un buen padding */
    ...
    margin-right: 0; /* Asegura que el botón se quede en la parte derecha */
